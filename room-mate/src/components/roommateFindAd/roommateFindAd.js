...
const RoommateFindAd = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        await axios.post('http://localhost:5000/api/addRoom', formData)
                        ...
                        <form className="form cf" onSubmit={handleFormSubmit}>
                            {
                                ...
                                <div className="first-step">
                                    ...
                                    <div className="row mb-3 mt-5">
                                        ...
                                        <div className="col-md">
                                            <div className="form-floating">
                                                <input type="text" name="deposit" value={firstStep.deposit} onBlur={handleBlur} className="form-control" id="deposit" />
